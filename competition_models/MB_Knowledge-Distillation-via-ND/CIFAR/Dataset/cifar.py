...
def CIFAR(name='cifar10', valid_size=None):
    ...
    if name == "cifar10":
        train_data = datasets.CIFAR10(root="Dataset/data", train=True, download=True)
        test_data = datasets.CIFAR10(root="Dataset/data", train=False, download=True)
        num_class = 10
        ...
        train_data = datasets.CIFAR100(root="Dataset/data", train=True, download=True)
        test_data = datasets.CIFAR100(root="Dataset/data", train=False, download=True)
        num_class = 100
